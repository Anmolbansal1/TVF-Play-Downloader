...
# print(m3u8_obj.iframe_playlists)
# s = 1
...
# for iframe_playlist in m3u8_obj.iframe_playlists:
#     print(iframe_playlist.absolute_uri)
#     filename = "Test-%i.mp4" %s 
#     print(filename)
#     resp = sessions.get(iframe_playlist.absolute_uri, headers=headers_2)
#     with open(filename, 'wb') as fd:
#     	for i, chunk in enumerate(resp.iter_content(chunk_size=10 ** 5)):
#     		fd.write(chunk)
#     print(iframe_playlist.iframe_stream_info.resolution)
#     s+= 1
# print(m3u8_obj)
# try:
# 	brightcove_json = brightcove_reponse.json()
# 	print(brightcove_json)
# 	for src in brightcove_json['sources']:
